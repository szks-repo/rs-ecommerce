...
pub async fn list_audit_logs(
    ...
    Ok((
        StatusCode::OK,
        Json(pb::ListAuditLogsResponse { logs, page: Some(page) }),
    ))
}
...
pub async fn list_audit_actions(
    ...
    Ok((StatusCode::OK, Json(pb::ListAuditActionsResponse { actions })))
}
...
fn audit_action_type(action: &AuditAction) -> i32 {
    match action {
        ...
        AuditAction::StoreSettingsUpdate => pb::AuditActionType::AuditActionStoreSettingsUpdate as i32,
        AuditAction::StoreSettingsInitialize => pb::AuditActionType::AuditActionStoreSettingsInitialize as i32,
        AuditAction::MallSettingsInitialize => pb::AuditActionType::AuditActionMallSettingsInitialize as i32,
        AuditAction::MallSettingsUpdate => pb::AuditActionType::AuditActionMallSettingsUpdate as i32,
        AuditAction::StoreLocationUpsert => pb::AuditActionType::AuditActionStoreLocationUpsert as i32,
        AuditAction::StoreLocationDelete => pb::AuditActionType::AuditActionStoreLocationDelete as i32,
        AuditAction::ShippingZoneUpsert => pb::AuditActionType::AuditActionShippingZoneUpsert as i32,
        AuditAction::ShippingZoneDelete => pb::AuditActionType::AuditActionShippingZoneDelete as i32,
        AuditAction::ShippingRateUpsert => pb::AuditActionType::AuditActionShippingRateUpsert as i32,
        AuditAction::ShippingRateDelete => pb::AuditActionType::AuditActionShippingRateDelete as i32,
        ...
        AuditAction::IdentityInviteAccept => pb::AuditActionType::AuditActionIdentityInviteAccept as i32,
        ...
        AuditAction::CustomerIdentityUpsert => pb::AuditActionType::AuditActionCustomerIdentityUpsert as i32,
        AuditAction::CustomerAddressUpsert => pb::AuditActionType::AuditActionCustomerAddressUpsert as i32,
    }
}
