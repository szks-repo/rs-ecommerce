...
impl AuditAction {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            AuditAction::IdentityInviteAccept => "identity.invite_accept",
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            AuditAction::IdentityInviteAccept => "Invite accepted",
...
impl From<IdentityAuditAction> for AuditAction {
    fn from(action: IdentityAuditAction) -> Self {
        match action {
            ...
            IdentityAuditAction::InviteAccept => AuditAction::IdentityInviteAccept,
